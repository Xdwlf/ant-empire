...
const descriptions = {
  temperature: [{desc: 'frozen', risk: 10, resource: 3},{desc: 'cold', risk: 8, resource: 4},{
    desc: 'chilly', risk: 5, resource: 5},{desc: 'mild', risk: 2, resource: 7},
    {desc: 'warm', risk: 3, resource: 8},{
    desc: 'hot', risk: 5, resource: 6}, {desc: 'searing', risk: 8, resource: 3
  }],
  humidity: [{desc: 'very wet', risk: 8, resource:10}, {desc: 'wet', risk: 5, resource: '8'},
  {desc: 'dry', risk: 7, resource: 5}, {desc: 'very dry', risk: 10, resource:3}],
  ...
  human: [{desc: 'There is a human city located nearby', risk: 10},
    ...
    {desc: 'The scent of humans here is faint', risk: 4},
    {desc: 'You can tell that humans do not gather or dwell near here.', risk: 1}]
}
